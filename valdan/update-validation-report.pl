...
BEGIN
{
    ...
    (
        ...
        'UD_Croatian-SET'               => ['lang-spec-doc', 'leaf-aux-cop', 'leaf-cc', 'leaf-fixed', 'leaf-mark-case', 'leaf-punct', 'orphan-parent', 'punct-causes-nonproj', 'punct-is-nonproj', 'rel-upos-advmod', 'rel-upos-aux', 'rel-upos-case', 'rel-upos-cc', 'rel-upos-compound', 'rel-upos-cop', 'rel-upos-det', 'rel-upos-expl', 'rel-upos-mark', 'rel-upos-nummod', 'rel-upos-punct', 'upos-rel-punct', 'aux-lemma', 'cop-lemma'],
        ...
        'UD_English-EWT'                => ['goeswith-gap', 'goeswith-nospace', 'leaf-aux-cop', 'leaf-cc', 'leaf-fixed', 'leaf-goeswith', 'leaf-punct', 'right-to-left-appos', 'right-to-left-goeswith', 'punct-causes-nonproj', 'punct-is-nonproj', 'rel-upos-advmod', 'rel-upos-aux', 'rel-upos-compound', 'rel-upos-det', 'rel-upos-expl', 'rel-upos-mark', 'rel-upos-nummod', 'rel-upos-punct', 'upos-rel-punct'],
        ...
        'UD_Indonesian-GSD'             => ['lang-spec-doc', 'leaf-cc', 'leaf-fixed', 'leaf-mark-case', 'leaf-punct', 'right-to-left-appos', 'punct-causes-nonproj', 'punct-is-nonproj', 'rel-upos-advmod', 'rel-upos-aux', 'rel-upos-cc', 'rel-upos-det', 'rel-upos-mark', 'rel-upos-nummod', 'rel-upos-punct', 'too-many-subjects', 'upos-rel-punct', 'aux-lemma', 'cop-lemma'],
        ...
        'UD_Japanese-GSD'               => ['aux-lemma'],
        'UD_Japanese-Modern'            => ['aux-lemma'],
        'UD_Japanese-PUD'               => ['aux-lemma'],
        ...
        'UD_Korean-PUD'                 => ['lang-spec-doc', 'goeswith-gap', 'leaf-aux-cop', 'right-to-left-appos', 'punct-causes-nonproj', 'punct-is-nonproj', 'rel-upos-advmod', 'rel-upos-aux', 'rel-upos-nummod', 'aux-lemma'],
        ...
        'UD_Latin-ITTB'                 => ['leaf-aux-cop', 'leaf-fixed', 'leaf-mark-case', 'leaf-punct', 'right-to-left-appos', 'orphan-parent', 'punct-causes-nonproj', 'punct-is-nonproj', 'rel-upos-advmod', 'rel-upos-aux', 'rel-upos-cc', 'rel-upos-cop', 'rel-upos-mark', 'rel-upos-punct', 'upos-rel-punct', 'aux-lemma', 'cop-lemma'],
        ...
        'UD_Naija-NSC'                  => ['lang-spec-doc', 'orphan-parent', 'aux-lemma'],
        ...
        'UD_Serbian-SET'                => ['lang-spec-doc', 'leaf-aux-cop', 'leaf-cc', 'leaf-fixed', 'leaf-mark-case', 'leaf-punct', 'orphan-parent', 'punct-causes-nonproj', 'punct-is-nonproj', 'rel-upos-advmod', 'rel-upos-aux', 'rel-upos-case', 'rel-upos-cop', 'rel-upos-det', 'rel-upos-mark', 'rel-upos-nummod', 'rel-upos-punct', 'upos-rel-punct', 'aux-lemma', 'cop-lemma'],
        ...
        'UD_Telugu-MTG'                 => ['lang-spec-doc', 'orphan-parent', 'punct-causes-nonproj', 'rel-upos-advmod', 'rel-upos-cc', 'rel-upos-mark', 'rel-upos-punct', 'upos-rel-punct'],
        ...
        'UD_Turkish-PUD'                => ['orphan-parent', 'aux-lemma'],
    ...
    %last_valid_release =
    (
        'UD_Afrikaans-AfriBooms'        => '2.5',
        'UD_Akkadian-PISANDUB'          => '2.5',
        'UD_Amharic-ATT'                => '2.5',
        'UD_Ancient_Greek-PROIEL'       => '2.5',
        'UD_Ancient_Greek-Perseus'      => '2.5',
        'UD_Arabic-NYUAD'               => '2.5',
        'UD_Arabic-PADT'                => '2.5',
        'UD_Arabic-PUD'                 => '2.5',
        'UD_Armenian-ArmTDP'            => '2.5',
        'UD_Assyrian-AS'                => '2.5',
        'UD_Bambara-CRB'                => '2.5',
        'UD_Basque-BDT'                 => '2.5',
        'UD_Belarusian-HSE'             => '2.5',
        'UD_Bhojpuri-BHTB'              => '2.5',
        'UD_Breton-KEB'                 => '2.5',
        'UD_Bulgarian-BTB'              => '2.5',
        'UD_Buryat-BDT'                 => '2.5',
        'UD_Cantonese-HK'               => '2.5',
        'UD_Catalan-AnCora'             => '2.5',
        'UD_Chinese-CFL'                => '2.5',
        'UD_Chinese-GSD'                => '2.5',
        'UD_Chinese-GSDSimp'            => '2.5',
        'UD_Chinese-HK'                 => '2.5',
        'UD_Chinese-PUD'                => '2.5',
        'UD_Classical_Chinese-Kyoto'    => '2.5',
        'UD_Coptic-Scriptorium'         => '2.5',
        'UD_Croatian-SET'               => '2.5',
        'UD_Czech-CAC'                  => '2.5',
        'UD_Czech-CLTT'                 => '2.5',
        'UD_Czech-FicTree'              => '2.5',
        'UD_Czech-PDT'                  => '2.5',
        'UD_Czech-PUD'                  => '2.5',
        'UD_Danish-DDT'                 => '2.5',
        'UD_Dutch-Alpino'               => '2.5',
        'UD_Dutch-LassySmall'           => '2.5',
        'UD_English-ESL'                => '2.5',
        'UD_English-EWT'                => '2.5',
        'UD_English-GUM'                => '2.5',
        'UD_English-LinES'              => '2.5',
        'UD_English-PUD'                => '2.5',
        'UD_English-ParTUT'             => '2.5',
        'UD_English-Pronouns'           => '2.5',
        'UD_Erzya-JR'                   => '2.5',
        'UD_Estonian-EDT'               => '2.5',
        'UD_Estonian-EWT'               => '2.5',
        'UD_Faroese-OFT'                => '2.5',
        ...
        'UD_French-GSD'                 => '2.5',
        'UD_French-PUD'                 => '2.5',
        'UD_French-ParTUT'              => '2.5',
        'UD_French-Sequoia'             => '2.5',
        'UD_French-Spoken'              => '2.5',
        'UD_Galician-CTG'               => '2.5',
        'UD_Galician-TreeGal'           => '2.5',
        'UD_German-GSD'                 => '2.5',
        'UD_German-HDT'                 => '2.5',
        'UD_German-LIT'                 => '2.5',
        'UD_German-PUD'                 => '2.5',
        'UD_Gothic-PROIEL'              => '2.5',
        'UD_Greek-GDT'                  => '2.5',
        'UD_Hebrew-HTB'                 => '2.5',
        'UD_Hindi-HDTB'                 => '2.5',
        'UD_Hindi-PUD'                  => '2.5',
        'UD_Hindi_English-HIENCS'       => '2.5',
        'UD_Hungarian-Szeged'           => '2.5',
        'UD_Indonesian-GSD'             => '2.5',
        'UD_Indonesian-PUD'             => '2.5',
        'UD_Irish-IDT'                  => '2.5',
        'UD_Italian-ISDT'               => '2.5',
        'UD_Italian-PUD'                => '2.5',
        'UD_Italian-ParTUT'             => '2.5',
        'UD_Italian-PoSTWITA'           => '2.5',
        'UD_Italian-TWITTIRO'           => '2.5',
        'UD_Italian-VIT'                => '2.5',
        'UD_Japanese-BCCWJ'             => '2.5',
        'UD_Japanese-GSD'               => '2.5',
        'UD_Japanese-KTC'               => '1.4',
        'UD_Japanese-Modern'            => '2.5',
        'UD_Japanese-PUD'               => '2.5',
        'UD_Karelian-KKPP'              => '2.5',
        'UD_Kazakh-KTB'                 => '2.5',
        'UD_Komi_Permyak-UH'            => '2.5',
        'UD_Komi_Zyrian-IKDP'           => '2.5',
        'UD_Komi_Zyrian-Lattice'        => '2.5',
        'UD_Korean-GSD'                 => '2.5',
        'UD_Korean-Kaist'               => '2.5',
        'UD_Korean-PUD'                 => '2.5',
        'UD_Kurmanji-MG'                => '2.5',
        'UD_Latin-ITTB'                 => '2.5',
        'UD_Latin-PROIEL'               => '2.5',
        'UD_Latin-Perseus'              => '2.5',
        'UD_Latvian-LVTB'               => '2.5',
        'UD_Lithuanian-ALKSNIS'         => '2.5',
        'UD_Lithuanian-HSE'             => '2.5',
        'UD_Livvi-KKPP'                 => '2.5',
        'UD_Maltese-MUDT'               => '2.5',
        'UD_Marathi-UFAL'               => '2.5',
        'UD_Mbya_Guarani-Dooley'        => '2.5',
        'UD_Mbya_Guarani-Thomas'        => '2.5',
        'UD_Moksha-JR'                  => '2.5',
        'UD_Naija-NSC'                  => '2.5',
        'UD_North_Sami-Giella'          => '2.5',
        'UD_Norwegian-Bokmaal'          => '2.5',
        'UD_Norwegian-Nynorsk'          => '2.5',
        'UD_Norwegian-NynorskLIA'       => '2.5',
        'UD_Old_Church_Slavonic-PROIEL' => '2.5',
        'UD_Old_French-SRCMF'           => '2.5',
        'UD_Old_Russian-RNC'            => '2.5',
        'UD_Old_Russian-TOROT'          => '2.5',
        'UD_Persian-Seraji'             => '2.5',
        'UD_Polish-LFG'                 => '2.5',
        'UD_Polish-PDB'                 => '2.5',
        'UD_Polish-PUD'                 => '2.5',
        'UD_Portuguese-Bosque'          => '2.5',
        'UD_Portuguese-GSD'             => '2.5',
        'UD_Portuguese-PUD'             => '2.5',
        'UD_Romanian-Nonstandard'       => '2.5',
        'UD_Romanian-RRT'               => '2.5',
        'UD_Romanian-SiMoNERo'          => '2.5',
        'UD_Russian-GSD'                => '2.5',
        'UD_Russian-PUD'                => '2.5',
        'UD_Russian-SynTagRus'          => '2.5',
        'UD_Russian-Taiga'              => '2.5',
        'UD_Sanskrit-UFAL'              => '2.5',
        'UD_Scottish_Gaelic-ARCOSG'     => '2.5',
        'UD_Serbian-SET'                => '2.5',
        'UD_Skolt_Sami-Giellagas'       => '2.5',
        'UD_Slovak-SNK'                 => '2.5',
        'UD_Slovenian-SSJ'              => '2.5',
        'UD_Slovenian-SST'              => '2.5',
        'UD_Spanish-AnCora'             => '2.5',
        'UD_Spanish-GSD'                => '2.5',
        'UD_Spanish-PUD'                => '2.5',
        'UD_Swedish-LinES'              => '2.5',
        'UD_Swedish-PUD'                => '2.5',
        'UD_Swedish-Talbanken'          => '2.5',
        'UD_Swedish_Sign_Language-SSLC' => '2.5',
        'UD_Swiss_German-UZH'           => '2.5',
        'UD_Tagalog-TRG'                => '2.5',
        'UD_Tamil-TTB'                  => '2.5',
        'UD_Telugu-MTG'                 => '2.5',
        'UD_Thai-PUD'                   => '2.5',
        ...
        'UD_Turkish-PUD'                => '2.5',
        'UD_Ukrainian-IU'               => '2.5',
        'UD_Upper_Sorbian-UFAL'         => '2.5',
        'UD_Urdu-UDTB'                  => '2.5',
        'UD_Uyghur-UDT'                 => '2.5',
        'UD_Vietnamese-VTB'             => '2.5',
        'UD_Warlpiri-UFAL'              => '2.5',
        'UD_Welsh-CCG'                  => '2.5',
        'UD_Wolof-WTB'                  => '2.5',
        'UD_Yoruba-YTB'                 => '2.5'
    );

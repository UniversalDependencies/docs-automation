...
sub write_data_json
{
    ...
    my $data = shift;
    my $filename = shift;
    my $json = '{"WARNING": "Please do not edit this file manually. Such edits will be overwritten without notice. Go to http://quest.ms.mff.cuni.cz/udvalidator/cgi-bin/unidep/docs-automation/valrules/specify_auxiliary.pl instead.",'."\n\n";
    $json .= '"auxiliaries": ['."\n";
    my @jsonrecords = ();
    foreach my $row (@{$data})
    {
